...
const class chunk& object::chunk() const { return *c; }
const class world& object::world() const { return c->world(); }
class chunk& object::chunk() { return *c; }
class world& object::world() { return c->world(); }
