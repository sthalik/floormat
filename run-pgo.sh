...
# --driver=profile, not =all: both run all 12 scenes, since --driver-scenes defaults to "all"
# and fills scene_mask before the mode filter is reached (pgo-driver.cpp:1401). Only profile
